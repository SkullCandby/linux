...
this.stop_input=()=>{stat_input_mode=false;less.stat_input_mode=false;};
this.set_stat_input_mode=arg=>{stat_input_mode=arg;x=0;less.stat_input_mode=arg;};
...
//Init«
this.init = (linesarg, fname, type, opts)=>{//«
